    ...
    <div className="p-6 bg-white min-h-screen">
      <div className="mb-8 flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button className="px-4 py-2 text-[12px] text-black rounded-lg hover:bg-gray-50 transition-colors border border-gray-300">
            여러명 추가
          </button>
          <button 
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {workers.map((worker) => (
                <tr key={worker.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-[16px] text-gray-900">{worker.level}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
